...
import { BatchRecoveryProof, CaseApi, createPriorityQueue, Customer, ExternalPaymentRequest, fetchJson, Invoice, LatestIntelligenceCycle, Portfolio, ProviderMode, Recommendation, Recovery, RecoveryAction, SimState, SimulationEvent, Workspace } from "./data";
...
export const queryKeys = {
  ...
  batchRecoveryProof: ["reconmate", "batch-recovery-proof"] as const,
...
export const useBatchRecoveryProof = () => useQuery({ queryKey: queryKeys.batchRecoveryProof, queryFn: () => fetchJson<BatchRecoveryProof>("/reports/batch-recovery"), ...liveQuery });
