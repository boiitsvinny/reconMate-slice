          ...
          <>
            ...
            <section aria-label="Top portfolio metrics" className="mb-5">
              <div className="hide-scrollbar flex snap-x snap-mandatory gap-3 overflow-x-auto pb-1 sm:grid sm:grid-cols-2 sm:overflow-visible xl:grid-cols-4">
                ...
                <PortfolioMetricCard className="min-w-[76vw] snap-start sm:min-w-0" label="Active disputes" value={String(recovery.data.cases_blocked_by_dispute)} detail="Recovery cases currently held for dispute review." tone="amber" />
